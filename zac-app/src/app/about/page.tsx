      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', maxWidth: '650px', margin: '0 auto', lineHeight: 1.65 }}>
            Zoology Animal Club (ZAC) is a global network of conservationists, zoologists, and nature enthusiasts cataloging our planet's biodiversity in real-time.
          </p>
        </div>
        ...
        >
          ...
          <p style={{ color: 'var(--text-primary)', lineHeight: 1.8, fontSize: '0.98rem', fontWeight: 300, marginBottom: '2rem' }}>
            We believe that you cannot protect what you do not understand. In partnership with community platforms like **iNaturalist**, ZAC provides field investigators, researchers, and citizen scientists with a unified suite of tools to log sightings, monitor migration paths, and track global conservation threats.
          </p>
            ...
            {[
              {
                ...
                desc: 'Deploying remote sensors and analyzing iNaturalist API networks to record global species distributions.'
              },
              {
                title: 'Habitat Protection',
                icon: <Shield size={20} />,
                desc: 'Sponsoring localized forest, ocean, and mountain rewilding initiatives in critical wildlife zones.'
              },
              {
                title: 'Community Education',
                icon: <Users size={20} />,
                desc: 'Equipping volunteers and schools with wildlife field log systems to inspire the next generation of naturalists.'
              }
            ].map((p, idx) => (
        ...
        >
          ...
          <p style={{ fontSize: '0.92rem', color: 'var(--text-secondary)', maxWidth: '500px', margin: '0 auto 1.8rem', lineHeight: 1.6 }}>
            Ready to contribute? Create a naturalist profile today to explore the conservation dashboard, sync iNaturalist projects, and link field observations.
          </p>
